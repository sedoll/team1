...
<head>
    ...
    <style>
        ...
        .tb1 th { width:120px; line-height:32px; padding-top:8px; padding-bottom:8px;
        border-top:1px solid #333; border-bottom:1px solid #333;
            background-color:deepskyblue; color:#fff; }
        .tb1 td { width:670px; line-height:32px; padding-top:8px; padding-bottom:8px;
                ...
                <form name="frm1" action="joinpro.jsp" method="post" onsubmit="return inform(this)">
                    <table class="tb1">
                        ...
                        <tr>
                            ...
                            <div class="btn_fr">
                                <input type="checkbox" id="ck_item1" name="ck_item1"> <label for="ck_item1">약관의 동의</label><br><br>
                            </div>
                            </td>
                        </tr>
                        <tr>
