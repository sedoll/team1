...
<%
    ...
    try {
        ...
        String sql = "";
        if(lev == 0) {
            sql = "update board_stu set title=?, content=? where bno=? and lev=0";
        } else {
            sql = "update board_stu set title=?, content=? where bno=? and lev=1";
        }
...
//            response.sendRedirect("updateQuestion.jsp?bno="+bno);
            ...
            out.println("<script>location.href='/pro01/board_stu/boardStuList.jsp'</script>"); //location
        }
