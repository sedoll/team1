...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="./boardStuList.jsp">학생게시판</a> &gt; <a href="./getBoardStu.jsp?bno=<%=bno%>">게시글</a></p>
        </div>
                ...
                <table class="tb1">
                    ...
                    <tr>
                        <td>
                            ...
                            <a href="./updateBoardStu.jsp?bno=<%=bno%>&lev=0" class="inbtn">수정</a>
                            <% } %>
                        </td>
                        <td>
                            <% if (sid != null &&( sid.equals("admin") || sid.equals(id2))) { %>
                            <a href="./deleteBoardStupro.jsp?bno=<%=bno%>&lev=0" class="inbtn delete_btn" >삭제</a>
                            <% } %>
                        </td>
                ...
                <table class="tb2" id="myTable">
                    ...
                    <tr>
                        ...
                        <td class="item4">
                            ...
                            <a href="./updateAnsStu.jsp?bno=<%=boardList.get(i).getBno()%>&lev=1" class="inbtn">수정</a>
                            <% } %>
                            <% if(sid!=null && (sid.equals(boardList.get(i).getAuthor()) || sid.equals("admin")) && boardList.get(i).getLev() != 0) { %>
                            <a href="./deleteBoardStupro.jsp?bno=<%=boardList.get(i).getBno()%>&lev=1" class="inbtn delete_btn"> 삭제 </a>
                            <% } %>
                        </td>
